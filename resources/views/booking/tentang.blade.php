...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <p class="text-gray-700 mb-4">Hotel Kami adalah tempat yang nyaman dan terjangkau untuk penginapan Anda. Dengan lokasi yang strategis dan fasilitas yang memadai.</p>
